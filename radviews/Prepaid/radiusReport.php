<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Raidus Connections Report
        <small>Reports / Radius Connection Report</small>
      </h1>
    </section>
                    ...
                    <div class="box-tools">
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                //exit;
                                if(!empty($radiusSummery))
                                {
                                    $row_count = 1;
                                    foreach($radiusSummery as $record)
                                    {
                                ?>
                                <tr>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>radiusReport" method="POST" id="searchList">
                            <div class="input-group">
                                ...
                                <select name="searchText3" class="selectpicker pull-left" style="width: 150px; height: 30px;">
                                        <option value="0" <?php if($searchText3==0){ echo "selected=selected"; } ?>>Group by User-ID</option>
                                        <option value="1" <?php if($searchText3==1){ echo "selected=selected"; } ?>>Group By NAS-IP</option>
                                        <option value="2" <?php if($searchText3==2){ echo "selected=selected"; } ?>>Group By Server-ID</option>
                                        <option value="3" <?php if($searchText3==3){ echo "selected=selected"; } ?>>Groupb By Type</option>
                                        <option value="4" <?php if($searchText3==4){ echo "selected=selected"; } ?>>Group By Month</option>
                                        <option value="5" <?php if($searchText3==5){ echo "selected=selected"; } ?>>Group By Year</option>
                                </select>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <?php
                    if(!empty($radiusReport))
                    {
                        $row_count = 1;
                        foreach($radiusReport as $record)
                        {


                            /*A.managername, B.username,
                            C.nasipaddress, C.calledstationid, C.servicetype, C.acctstarttime, C.acctstoptime,
                            C.acctsessiontime, C.acctinputoctets, C.acctoutputoctets, C.framedipaddress*/
                    ?>
                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap"><?php echo $record->nasipaddress ?></td>

                        <td style="white-space:nowrap"><?php echo $record->calledstationid ?></td>
                        <td style="white-space:nowrap"><?php echo $record->users ?></td>

                        <td style="white-space:nowrap"><?php echo $record->acctstarttime ?></td>
                        <td style="white-space:nowrap"><?php echo $record->acctstoptime ?></td>
                        <td style="white-space:nowrap"><?php echo $record->acctsessiontime ?></td>
                        <td style="white-space:nowrap"><?php echo $record->acctinputoctets ?></td>
                        <td style="white-space:nowrap"><?php echo $record->acctoutputoctets ?></td>
                        <td style="white-space:nowrap"><?php echo $record->framedipaddress ?></td>
