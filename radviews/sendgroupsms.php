                    ...
                    <form role="form" id="sendMsgNow" action="<?php echo base_url() ?>sendGroupMsgNow" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="typeofsms">TYPE</label>
                                        <select class="form-control required" id="typeofsms" name="typeofsms">
                                            <option value="0">Select User Group</option>
                                                <option value="0" selected=selected>Active (Not Included Blocked)</option>
                                                <option value="1">Expired Customers Only</option>
                                                <option value="2">Blocked Customers Only</option>
                                         </select>
                                    </div>
                                </div>
