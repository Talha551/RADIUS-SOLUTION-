    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        <i class="fas fa-plus"></i> Attribute Management
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Enter Attribute Details</h3>
                        </div><!-- /.card-header -->
                        <!-- form start -->
                        <?php $this->load->helper("form"); ?>
                        <form role="form" id="addAttribute" action="<?php echo base_url() ?>Services_controller/insertAttribute" method="post" role="form">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">                                
                                        <div class="form-group">
                                            <label for="attname">Attribute Name</label><span style="color:red;">*</span>
                                            <input type="text" class="form-control required" value="<?php echo set_value('attname'); ?>" id="attname" name="attname" maxlength="255">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control required" id="atttype" name="atttype">
                                                <option value="0">Attribute-User</option>
                                                <option value="1">Attribute-Group</option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="descr" name="descr" maxlength="255" rows="3"><?php echo set_value('descr'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.card-body -->
