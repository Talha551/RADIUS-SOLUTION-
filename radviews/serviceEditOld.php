    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        <i class="fas fa-users"></i> Edit Service
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" id="baseprice" value="<?php echo $baseprice; ?>" name="baseprice" maxlength="20" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
