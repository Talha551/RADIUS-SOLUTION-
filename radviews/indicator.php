<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Indicators Report
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <?php
                    if(!empty($userIndictor))
                    {
                        $row_count = 1;
                        foreach($userIndictor as $record)
                        {
                    ?>
                    ...
                    <td <?php 
                        ...
                        ?>><?php echo $row_count; ?>.</td>

                        <td <?php 
                            if($status <> 'Success')
                                echo 'style="color: red;"';
                        ?>><?php echo $record->owner ?></td>

                        <td <?php 
                            if($status <> 'Success')
                                echo 'style="color: red;"';
                        ?>><?php echo $record->Month ?></td>

                        <td <?php 
                            if($status <> 'Success')
                                echo 'style="color: red;"';
                        ?>><?php echo $record->PrevUsers ?></td>

                        <td <?php 
                            if($status <> 'Success')
                                echo 'style="color: red;"';
                        ?>><?php echo $record->Users ?></td>

                        <td <?php 
                            if($status <> 'Success')
                                echo 'style="color: red;"';
                        ?>><?php echo $record->TotalUsers ?></td>
