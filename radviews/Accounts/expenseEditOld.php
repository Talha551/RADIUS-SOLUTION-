<?php
    ...
    $jvid = $expenseInfo->jvid;
    $jvdate = $expenseInfo->jvdate;
    $acctdr = $expenseInfo->acctdr;
    $acctcr = $expenseInfo->acctcr;
    $desc = $expenseInfo->desc;
    $jvtype = $expenseInfo->jvtype;
    $manager = $expenseInfo->managername;
    $debit = $expenseInfo->debit;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fas fa-users"></i> Edit Expense Entry
        <small>Update / Edit Expense Entry</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="card card-primary">
                    ...
                    <form role="form" id="updateExpenseEntry" action="<?php echo base_url() ?>updateExpenseEntry" method="post" role="form">
                        <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="EXPENSES" id="jvtype" name="jvtype" maxlength="50" readonly>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <select class="form-control required" id="walletid" name="walletid">
                                            ...
                                            <?php
                                                if(!empty($wallets))
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                            <option value="<?php echo $rl->walletid ?>" <?php if($rl->walletid == $expenseInfo->walletid) {echo "selected=selected";} ?>><?php echo $rl->walletname ?></option>
                                                        <?php
                                                    }
                                                }
                                            ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="acccr">Paid From</label>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="amount" value="<?php echo $debit; ?>" name="amount" maxlength="20" autocomplete="off">
                                    </div>
                                </div>
