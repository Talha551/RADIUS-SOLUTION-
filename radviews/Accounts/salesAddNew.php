<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> New Sales Entry
                    ...
                    <form role="form" id="saveAccounts" action="<?php echo base_url() ?>saveJv" method="post" role="form">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="SALES" id="jvtype" name="jvtype" maxlength="50" readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="acccr" name="acccr">
                                            <option value="0">Select Sales A/C</option>
                                            <?php
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control required" id="username" value="<?php echo $username; ?>" name="username" maxlength="20" autocomplete="off">
                                    </div>
                                </div>
                            </div>
