...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-users"></i> Edit Sales Entry <small class="text-muted">Update / Edit Sales Entry</small></h1>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-8">
            <div class="card card-primary">
              <div class="card-header bg-primary">
                <h3 class="card-title text-white mb-0">Sales Details</h3>
              </div>
              <?php $this->load->helper("form"); ?>
              <form role="form" id="updateSalesEntry" action="<?php echo base_url() ?>updateSalesEntry" method="post">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="SALES" id="jvtype" name="jvtype" maxlength="50" readonly>
                      </div>
                    </div>
                  </div>
                  <?php 
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="accdr">Cash Account</label>
