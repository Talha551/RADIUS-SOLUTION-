<?php
    ...
    $invinqty = $transInfo->invinqty;
    $invprice = $transInfo->invprice;
    $invtotal = $transInfo->invtotal;
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="card card-primary">
                    ...
                    <form role="form" id="updateStockEntry" action="<?php echo base_url() ?>updateStockEntry/<?php echo $stocktype ?>" method="post" role="form">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-2">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $jvid; ?>" id="jvid" name="jvid" maxlength="50" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">                                
                                    <div class="form-group">
                                        <label for="jvtype">Voucher Type</label>
                                        <input type="text" class="form-control required" value="<?php echo $jvtypeName ?>" id="jvtype" name="jvtype" maxlength="50" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" id="jvdate" value="<?php echo $jvdate ?>" name="jvdate" maxlength="16" readonly>
                                        </div>
                                </div>
                                            ...
                                            <?php
                                                if(!empty($creditaccount))
                                                {
                                                    foreach ($creditaccount as $rl)
                                                    {
                                                        ...
                                                        {
                                                        ?>
                                                            <option value="<?php echo $rl->acctid ?>" <?php if($rl->acctid == $acctcr) {echo "selected=selected";} ?>><?php echo $rl->accname ?></option>
                                                        <?php
                                                        }else{
                                                        ?>
                                                            <option value="<?php echo $rl->acctid ?>" <?php if($rl->acctid == $acctdr) {echo "selected=selected";} ?>><?php echo $rl->accname ?></option>
                                                        <?php
                                                        }
                                                    }
                                                }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="invinqty" value="<?php echo $invinqty; ?>" name="invinqty" maxlength="20" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control required" id="invprice" value="<?php echo $invprice; ?>" name="invprice" maxlength="20" placeholder='0.00' autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control required" id="invtotal" value="<?php echo $invtotal; ?>" name="invtotal" maxlength="20" placeholder='0.00' autocomplete="off" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $desc; ?>" id="desc" name="desc" maxlength="250" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control required" value="<?php echo $username; ?>" id="username" name="username" maxlength="250" autocomplete="off" readonly>
                                    </div>
                                </div>
                            </div>
